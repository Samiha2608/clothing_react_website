  ...
  return (
    <div className="bg-[#F5F3DB] min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-10">
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-start bg-white p-10 rounded-lg shadow-lg">
          <img src={product.image} alt={product.name} className="w-full md:w-1/2 rounded-lg mb-6 md:mb-0" />
          <div className="ml-0 md:ml-10">
            <h2 className="text-2xl md:text-3xl font-bold text-[#585B42] mb-4">{product.name}</h2>
            ...
            <div className="mt-4">
              ...
              <select className="mt-2 p-2 border border-gray-400 rounded w-full md:w-auto">
